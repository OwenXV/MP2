        ...
        <Container className="text-white justify-content-center">
          ...
          <Accordion defaultActiveKey="0" className="pt-4">
            ...
            <Accordion.Item eventKey="2">
              ...
              <Accordion.Body>
                <h3>You can watch Netflix on a variety of devices, including:</h3>
                  <ul>
                    <li>Smart TVs: Most modern smart TVs come with a built-in Netflix app that you can access and stream content directly on your TV.</li>
                    <li>Streaming devices: You can also watch Netflix on devices such as Apple TV, Roku, Chromecast, and Amazon Fire TV Stick.</li>
                    <li>Game consoles: If you have a PlayStation, Xbox, or Nintendo Switch, you can download the Netflix app and watch content on your gaming console.</li>
                    <li>Computers: You can watch Netflix on your desktop or laptop computer by visiting the Netflix website.</li>
